...
from PyQt5.QtCore import pyqtSignal, QTimer, Qt, QRect, QRectF, QPoint
...
class ElaLongPressButton(ElaPushButton):
    ...
    Example::
        ...
        button = LongPressButton(parent)
        button.setDuration(800)  # 设置 800ms 长按触发
