...
带有标题标签的可搜索下拉框，继承自 ElaSearchableComboBox，
支持汉字拼音首字母搜索。
"""
...
from .combo_box import ElaSearchableComboBox


class ElaCapsuleSearchableComboBox(ElaSearchableComboBox):
    """具名可搜索下拉框。

    带有标题标签的可搜索下拉框，支持汉字拼音首字母搜索。
    继承自 ElaSearchableComboBox，使用胶囊样式。
