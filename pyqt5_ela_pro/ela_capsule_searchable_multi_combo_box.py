...
带有标题标签的可搜索多选下拉框，继承自 ElaSearchableMultiComboBox，
支持汉字拼音首字母搜索。
"""
...
from .combo_box import ElaSearchableMultiComboBox


class ElaCapsuleSearchableMultiComboBox(ElaSearchableMultiComboBox):
    """具名可搜索多选下拉框。

    带有标题标签的可搜索多选下拉框，支持汉字拼音首字母搜索。
    继承自 ElaSearchableMultiComboBox，使用胶囊样式。
    ...
    Example::
        ...
        combo = ElaCapsuleSearchableMultiComboBox(parent, title="语言")
